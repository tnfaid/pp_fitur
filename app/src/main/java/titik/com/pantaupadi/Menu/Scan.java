...
public class Scan extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        resultDetailsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), DetectionDetailsActivity.class));
            }
        });
    ...
    private void setupNumberOfBandsControl() {
        ...
        final ArrayAdapter<String> modeElements = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item);
    ...
    public void onResume() {
        ...
        if (!OpenCVLoader.initDebug()) {
            ...
            OpenCVLoader.initAsync(OpenCVLoader.OPENCV_VERSION_3_0_0, getActivity(), baseLoaderCallback);
        } else {
