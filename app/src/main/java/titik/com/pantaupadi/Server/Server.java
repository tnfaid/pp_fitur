...
public class Server {
    public static final String URL = "http://10.10.30.90:8080/CI_PantauPadi/webService/";
    public static final String URL_IMG = "http://10.10.30.90:8080/CI_PantauPadi/gambar_unggah/daun/";
}
