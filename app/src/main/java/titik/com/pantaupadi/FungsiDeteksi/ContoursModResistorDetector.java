...
//            int kUnits = locationValues.valueAt(1);
//            int kPower = locationValues.valueAt(2);

            int value = warna1 ;
//            int value = locationValues.get(kTens) + locationValues.get(kUnits) + locationValues.get(kPower);
